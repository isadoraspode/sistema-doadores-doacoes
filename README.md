# Donation and Donor Management System
...
* **Validation & Error Handling:** Implements robust logic to identify common data inconsistencies, missing fields, or invalid inputs during the registration phase.
* **Reporting:** Automatically summarizes all system activities, performance, and processed logs into a structured final report file.

## 🛠️ Technologies & Tools

* **Core Language:** Java
* **Data Input:** CSV File Format
* **Outputs:** Plain Text (`.txt`) log and report generation
* **Paradigm:** Object-Oriented Programming (OOP)

## 📁 Project Structure

* All core logic, object models, and file-parsing components are built using native Java libraries.
